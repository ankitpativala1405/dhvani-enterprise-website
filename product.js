let data = [
  {
    id: 0,
    title:
      "DHVANI ENTERPRISE Portable Mini Sealing Machine, Handheld Packet Sealer for Food, Snacks, Chips, Fresh Storage, Plastic Bags Sealing Machine,(MULTICOLOR)",
    price: "199",
    MRP: "406",
    ...
    Descrip3:
      "1.Fully charge the battery before use.<br>Plug the portable heat sealer into the power cord to starr charging. When charging, the indicator red light will be on for a long time, and when fully charged, the indicatior red ligjt will be off. At this point you can start using the product.",
    Descrip4:
    ...
    Descrip6:
      "4.Press to seal the bag<br>Then simply press the knob and make it move equably. along the edge of any bag and it's sealed airtight.",
    Descrip7:
  ...
  },
  {
    id: 1,
    title:
      "DHVANI ENTERPRISE Women's Faux Georgette Stitched Top With Unstitched Santoon Bottom and Dupatta Full Sleeve Embroidered Anarkali Gown",
    price: "599",
    MRP: "2199",
    category: "clothing",
    subcategory: "gown",
    ...
    bullet8: "",
    Descrip1:
      "DHVANI ENTERPRISE provides you gHeavy Faux Georgette With Embroidered Work With Sequence ( Semi-Stitched ), Size: Max Up To 48 Inches, Length: Max Up To 52 Inches, Flair: 2.70 MTR.",
    Descrip2:
      "Traditional Indian wear Anarkali gowns and suits for women. This Anarkali gown sophisticated look and enhances the beauty of the women. Which can be worn for functions, festivals, parties, and even weddings also.",
    Descrip3:
      "You will be a center of attraction in the event once you ware it. DHVANI ENTERPRISE brings to you this Anarkali suit. Which are available in pink, wine, brown, Rama, green, white, and black shades of attractive colors and are made from georgette fabric.",
    Descrip4:
      "The Anarkali suit is a suitable choice when it comes to choosing ethnic wear or festive wear for your wardrobe. The gown features a beautiful flair with a floral border enhancing the style of the garment.",
    Descrip5:
...
function renderProducts(data) {
  data.map((ele,id) => {
    ...
    let bnbutton = document.createElement("button");
    bnbutton.innerHTML = "BUY NOW";
    bnbutton.addEventListener("click", () => {
      buyn();
    });

    let atbutton = document.createElement("button");
    atbutton.innerHTML = "ADD TO CART";
    ...
    div.append(image, title, price, bnbutton, atbutton);
  });
}
...
const subcategories = {
  ...
  "Beauty & Personal Care": [
    ...
    "fragrances for men",
    "fragrances for teenagers",
    "fragrances for adults",
    "make for women",
    "make for men",
    "makeup products",
  ],
...
document
  ...
  .addEventListener("change", filterbysubcategory);
...
const filterbyprice = () => {
  ...
  let filteredData = data.filter(
    (ele) => parseFloat(ele.price) <= priceOffilteredData
  );
...
document
  .getElementById("checkbox-submit")
