...
let productsdata = `
    <div id="product-detail">
        <div id="product-images">
            ...
            <div id="thumbnails">
                <img src="${temporary.image2}" alt="" id="image02">
                <img src="${temporary.image3}" alt="" id="image03">
                <img src="${temporary.image4}" alt="" id="image04">
                <img src="${temporary.image5}" alt="" id="image05">
                <img src="${temporary.image6}" alt="" id="image06">
                <img src="${temporary.image7}" alt="" id="image07">
                <img src="${temporary.image8}" alt="" id="image08">
            </div>
        </div>
        <div id="product-info">
...
let mainImage;
let thumbnail;
 function swapImages(thumbnailId, mainImageId) {
 
    let thumbnailSrc = document.getElementById(thumbnailId).src;
    let mainImageSrc = document.getElementById(mainImageId).src;

    mainImage.src = thumbnailSrc;
    thumbnail.src = mainImageSrc;
}
document.getElementById("image05").addEventListener("click", ()=>{
    let mainImage = document.getElementById("main-img");
    let thumbnail = document.getElementById("image05");

    let mainimagesrc=mainImage.src;
    let thumbnailsrc=thumbnail.src;

    swapImages("image05", "main-image"); 
});